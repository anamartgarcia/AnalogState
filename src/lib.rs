...
#[derive(Debug)]
pub struct AnalogStateProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AnalogStateProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AnalogState processing");
    
    let mut processor = AnalogStateProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AnalogStateProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AnalogStateProcessor::new(false);
